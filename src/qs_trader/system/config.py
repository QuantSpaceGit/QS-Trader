...
Minimal configuration for QS-Trader engine focused on DataService.
...
class CustomLibrariesConfig:
    ...
    Example:
        ...
        CustomLibrariesConfig(
            adapters="~/qs-trader-custom/adapters",
            strategies="~/qs-trader-custom/strategies",
            ...
        )
    """
...
class LoggingConfig:
    ...
    file_path: str = "logs/qs_trader.log"
    ...
    def to_logger_config(self):
        ...
        from qs_trader.system.log_system import LoggingConfig as LogSystemConfig
...
class SystemConfig:
    """
    Minimal system configuration for QS-Trader.
    ...
    def load(cls, config_path: Optional[Path] = None) -> "SystemConfig":
        ...
        2. ./config/qs_trader.yaml (project-relative)
        3. ./config/system.yaml (legacy fallback)
        4. ~/.qs_trader/qs_trader.yaml (user home)
        ...
        if config_path:
            ...
            project_config = Path("config/qs_trader.yaml")
            ...
            # User home
            home_config = Path.home() / ".qs_trader" / "qs_trader.yaml"
    ...
    def _from_dict(cls, config_dict: dict[str, Any]) -> "SystemConfig":
        ...
        logging = LoggingConfig(
            ...
            file_path=logging_dict.get("file_path") or "logs/qs_trader.log",
