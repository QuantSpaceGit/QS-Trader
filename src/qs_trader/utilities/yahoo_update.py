...
Usage:
    ...
    python -m qs_trader.utilities.yahoo_update

    # Update specific symbols
    python -m qs_trader.utilities.yahoo_update AAPL MSFT GOOGL

    # Update with date range
    python -m qs_trader.utilities.yahoo_update --start 2020-01-01 --end 2024-12-31

    # Force full refresh (re-download all data)
    python -m qs_trader.utilities.yahoo_update --full-refresh
"""
...
def load_data_sources_config() -> Optional[Dict[str, Any]]:
    ...
    2. ~/.qs_trader/data_sources.yaml (user home)
    ...
    config_paths = [
        ...
        Path.home() / ".qs_trader" / "data_sources.yaml",
    ]
...
Examples:
  ...
  # Update specific symbols
  python -m qs_trader.utilities.yahoo_update AAPL MSFT

  # Use different data source from data_sources.yaml
  python -m qs_trader.utilities.yahoo_update --data-source yahoo-us-equity-1d-csv

  # Override data directory path
  python -m qs_trader.utilities.yahoo_update --data-dir /path/to/data
