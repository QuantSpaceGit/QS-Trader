...
from qs_trader.libraries.performance.models import EquityCurvePoint, FullMetrics, ReturnPoint, TradeRecord
...
class ReportingService:
    ...
    def _build_strategy_metrics_snapshot(self, portfolio_event: PortfolioStateEvent) -> list:
        ...
        from qs_trader.events.events import StrategyMetrics
    ...
    def _build_period_snapshots(self, period_type: str) -> list:
        ...
        from qs_trader.events.events import PeriodMetricsSnapshot
