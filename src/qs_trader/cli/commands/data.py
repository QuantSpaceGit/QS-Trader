...
from qs_trader.cli.ui import (
    create_bar_table,
    create_cache_info_table,
    create_update_progress,
    create_update_summary_table,
)
from qs_trader.cli.ui.formatters import add_bar_data, add_cache_info_row, add_update_result_row
...
def raw_data(symbol: str, start_date: str, end_date: str, dataset: str):
    ...
    Example:
        ...
        qs-trader data raw --symbol AAPL --start-date 2020-01-01 --end-date 2020-01-31 --dataset yahoo-us-equity-1d-csv
    """
    console = Console()
...
def update_dataset(dataset: str, symbols: str, dry_run: bool, verbose: bool, force_reprime: bool, yes: bool):
    ...
    Examples:
        ...
        Examples:
        # Update dataset
        qs-trader data update --dataset yahoo-us-equity-1d-csv

        # Force re-prime for adapter without incremental support
        qs-trader data update --dataset my-custom-dataset --force-reprime
    """
    console = Console()
...
def cache_info(dataset: str):
    ...
    Examples:
        qs-trader data cache-info --dataset yahoo-us-equity-1d-csv
    """
    console = Console()
...
def yahoo_update_command(symbols: tuple, start: str, end: str, full_refresh: bool, data_source: str, data_dir: str):
    ...
    Examples:
        ...
        qs-trader data yahoo-update --data-source yahoo-us-equity-1d-csv

        # Override data directory
        qs-trader data yahoo-update --data-dir /path/to/data
