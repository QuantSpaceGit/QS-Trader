...
def backtest_command(
    ...
    1. Experiment directory: qs-trader backtest experiments/my_strategy/
       - Automatically finds my_strategy.yaml inside
       - Creates timestamped run directory with full metadata
    2. Direct config file: qs-trader backtest path/to/config.yaml
    ...
    Examples:
        ...
        qs-trader backtest experiments/momentum_strategy

        # Run with config file
        qs-trader backtest experiments/momentum_strategy/momentum_strategy.yaml

        # Silent mode (fastest execution)
        qs-trader backtest experiments/momentum_strategy --silent

        # Override replay speed
        qs-trader backtest experiments/momentum_strategy -r 0.5
        ...
        qs-trader backtest experiments/momentum_strategy -l debug

        # Interactive debugging (pause at each timestamp)
        qs-trader backtest experiments/momentum_strategy --interactive
    ...
    try:
        # Header
        console.rule("[bold blue]QS-Trader Backtest[/bold blue]")
        console.print()
