...
def test_build_html_footer_preserves_legacy_generated_at_and_run_directory(tmp_path: Path) -> None:
    """HTML footer should preserve the legacy generated-at and run-directory bytes."""
    generator = HTMLReportGenerator(tmp_path / "20240131_123456")
    performance = {
        "backtest_id": "stable-report",
        "start_date": "2024-01-01",
        "end_date": "2024-01-31",
        "duration_days": 30,
    ...
    with patch("qs_trader.services.reporting.html_reporter.datetime", _FrozenDateTime):
    ...
    assert "Generated by QS-Trader • 2024-01-31 12:34:56" in html
    assert "Raw data available in: 20240131_123456" in html
